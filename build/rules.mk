...
cpplint-noisy:
	$(PLUGIN_TEST_SUPPORT_DIR)/cpplint.py  --filter=-legal/copyright,-build/include,-readability/namespace,-whitespace/indent,-whitespace/line_length  --recursive --extensions=cpp,h,ino --exclude=$(BOARD_HARDWARE_PATH) --exclude=$(TRAVIS_ARDUINO_PATH) .
	# we turn off whitespace indent because artistic style uses two spaces for public: private: indents, not one style
